...
class ChannelAttention(nn.Module):
    def __init__(self, in_planes, ratio=16):
        ...
        self.avg_pool = nn.AvgPool2d(POOL_KERNEL)
        self.max_pool = nn.MaxPool2d(POOL_KERNEL)
...
class MiniASACoreML(nn.Module):
    def __init__(self, num_classes, in_channels=1, base_size=64,
        ...
        self.conv4 = ConvBlock(in_channels=base_size*4, out_channels=base_size*8, use_pool=False)
