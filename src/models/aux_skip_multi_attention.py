...
class AuxBlock(nn.Module):
    def __init__(self, last_fc, num_classes,
                 base_size, dropout, ratio, kernel_size):
        super().__init__()
...
class AuxSkipMultiAttention(nn.Module):
    def __init__(self, num_classes, base_size=64,
        ...
        self.aux1 = AuxBlock(last_fc, num_classes, base_size,
                             dropout, ratio, kernel_size)
        self.aux2 = AuxBlock(last_fc, num_classes, base_size,
                             dropout, ratio, kernel_size)
